...
export default function Home() {
  return (
    <div className='flex flex-row items-center bg-y_background h-screen'>
    <div className='flex flex-col w-2/3 h-screen'>
      <div className='flex flex-col'>
        <div className='flex flex-row justify-between items-center mt-11 ml-14'>
          ...
          <div className='flex items-center justify-between bg-white shadow-lg rounded-2xl shadow-zinc-500/50 border border-Neutral-950 w-52 h-9 p-4 mr-28'>
      ...
      <div className='w-4/5 h-[97.333333%] rounded-3xl mr-2.5 bg-slate-400'></div>
    </div>
  );
}
